...
describe('PermitDescription', () => {
  ...
  it('should create permit description with valid value', () => {
    const descriptionValue = 'To change the Uses in a commercial building (Main Floor - from General Retail Store to Indoor Participant Recreation Service, Second Floor - from General Retail Store to Professional, Financial and Office Support Services) and construct exterior alterations (enlarge the Garage door and re-develop the parking lot).';
    const descriptionObj = new PermitDescription(descriptionValue);
